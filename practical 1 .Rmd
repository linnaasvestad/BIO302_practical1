...
How should the p-value be interpreted?
  When the p-value is significant, the null hypothesis is rejected. In this case this means that if true correlation was zero, would be unlikely to get such a high correlation. 

...
bill_len_SD
bill_len_SE <- bill_len_SD/sqrt(344)
bill_len_SE
```
...
How should the p-value be interpreted?
  When the p-value is significant, the null hypothesis is rejected. In this case this   means that the true correlations is not equal to 0. 
...
cor(datasaurus.df$x, datasaurus.df$y, use = "pairwise.complete.obs")
